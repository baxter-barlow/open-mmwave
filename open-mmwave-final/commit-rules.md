...
- Evaluation or development kit references
...
- `sprr*/`, `swrr*/`, `swru*.pdf` (component datasheets)
...
| development platform terms | "development platform" / "reference board" |
...
git status
# sprr*, swrr*, CODEX_SESSION_PHASE* should NOT appear
```
...
4. [ ] Private files (sprr*, swrr*, sessions) not staged
